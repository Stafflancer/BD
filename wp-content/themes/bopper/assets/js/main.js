...
if (('complete' === document.readyState || 'loading' !== document.readyState) && !document.documentElement.doScroll) {
	...
	document.addEventListener('DOMContentLoaded', bopperMobileMenu);
}

function bopperMobileMenu() {
...
if (('complete' === document.readyState || 'loading' !== document.readyState) && !document.documentElement.doScroll) {
	...
	document.addEventListener('DOMContentLoaded', bopperOffCanvas);
}

function bopperOffCanvas() {
