 ...
 */
function bopper_cors_control() {
	header( 'Access-Control-Allow-Origin: *' );
}

add_action( 'rest_api_init', 'bopper_cors_control' );
 ...
 * @return string
 */
function bopper_no_wordpress_errors() {
	return '<strong>ERROR</strong>: Something is wrong!';
}

add_filter( 'login_errors', 'bopper_no_wordpress_errors' );