 ...
 *
 */
function bopper_categorized_blog() {
	$category_count = get_transient( 'bopper_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'bopper_categories', $category_count );
	}
 ...
 */
function bopper_copyright_year( $atts ) {
	// Setup defaults.
	$args = shortcode_atts( [
		'starting_year' => '',
		'separator'     => '-',
...
add_shortcode( 'bopper_copyright_year', 'bopper_copyright_year' );