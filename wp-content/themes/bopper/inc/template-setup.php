...
define( 'BOPPER_VERSION', $version_string );
define( 'THEME_TEXT_DOMAIN', 'bopper' );
 ...
 * @author Bop Design
 */
if ( ! function_exists( 'bopper_setup' ) ) {
	function bopper_setup() {
...
add_action( 'after_setup_theme', 'bopper_setup' );