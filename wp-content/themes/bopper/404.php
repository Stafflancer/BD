	...
	<main id="main" class="site-main site-content wp-block-group" role="main">
		...
		if ( have_rows( 'page_settings_404', 'option' ) ):
			while ( have_rows( 'page_settings_404', 'option' ) ): the_row();
				...
				$page_buttons_404   = get_sub_field( 'page_buttons_404_buttons_group' );
				...
				bopper_display_block_background_options( $display_options, $container_args, [], true );
				?>
				<div class="container position-relative h-100 z-10">
					...
					<?php if ( ! empty( $page_buttons_404 ) ): ?>
						<div class="page-buttons mt-5">
							<?php bopper_display_block_buttons( $page_buttons_404 ); ?>
						</div><!-- .page-buttons -->
					<?php endif; ?>
				</div>
				<?php bopper_close_block( $container_args['container'] );?>
			<?php endwhile; ?>
		<?php else: ?>
