...
$select_created_blog = get_field('select_created_blog');
if(!empty($select_created_blog)){

    // Create id attribute allowing for custom "anchor" value.
    $id = 'author-created-blog-' . $block['id'];
    ...
    $section_class_name = 'author-created-blog';
    ...
    <div class="author-created-blog-main"><?php
        ...
        <div class="author-created-blog-inner">
            <div class="author-created-blog-container">
                <div class="author-created-blog-inner-main"><?php
                    global $post; 
                    foreach ($select_created_blog as $post) 
                    { 
                        setup_postdata( $post ); 
