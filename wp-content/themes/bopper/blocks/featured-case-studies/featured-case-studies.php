            ...
            <div class="case-studies-inner-items"><?php
                ...
                foreach ($case_studies as $post) 
                {
                    ...
                    <div class="case-studies-item <?php if(!empty($mobile_image) && !empty($mobile_image['url']))
                            { echo "mobile-image-shown"; } ?>" id="casestudies<?php echo $row; ?>"><?php
                                ...
                                <div class="stats-row"><?php
                                    ...
                                    { 
                                        ...
                                        <div class="stats-item">
                                            <div class="prefix">
                                                <h3><?php echo esc_html( $prefix ); ?><span id="odometer<?php echo $row.$counter; ?>" class="stat odometernew" data-value="<?php echo esc_html( $stat ); ?>"><?php echo esc_html( $stat ); ?></span><?php echo esc_html( $suffix ); ?></h3><?php 
