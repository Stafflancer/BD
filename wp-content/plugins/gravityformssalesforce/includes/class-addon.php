		...
		if ( self::$_instance == null ) {
			...
			self::$_instance = new self(
				array(
					...
					'capabilities_settings_page' => 'gravityforms_salesforce_plugin_settings',
					'capabilities_form_settings' => 'gravityforms_salesforce_form_settings',
					'capabilities_uninstall'     => 'gravityforms_salesforce_uninstall' //TODO this may be bug in Gravity Forms
				)
			);
